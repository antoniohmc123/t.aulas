...
# concatenador (roda vários números ao mesmo tempo):

poissonSimulacao[c(
  1:10,
  15)
  ] # acessa os elementos 1, 2 até 10 e 15
...
# código que retorna ama outra coluna:
...
# %in% comparação de conjuntos com mais de uma variável:
